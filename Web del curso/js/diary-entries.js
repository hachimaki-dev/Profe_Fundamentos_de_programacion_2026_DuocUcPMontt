...
const diaryEntries = [
  ...
  {
    id: 'taller-micro-retos',
    date: '2026-03-24',
    emoji: '🧠',
    title: 'Taller: Micro-retos encadenados',
    description: 'Pequeños ejercicios paso a paso para dominar comparaciones, decisiones e iterar con whiles. Metodología diseñada para que no te pierdas.',
    tags: ['python', 'flow'],
    page: 'pages/taller-1.html',
  },
  {
    id: 'kahoot-proyeccion',
    date: '2026-03-26',
    emoji: '🎮',
    title: 'Juego de Integración en Clase',
    description: 'Repaso a viva voz estilo Kahoot. Validemos diagramas lógicos, condiciones y ciclos mientras competimos en clase.',
    tags: ['python', 'flow'],
    page: 'pages/quiz-proyeccion.html',
    isNew: true,
  },
];
